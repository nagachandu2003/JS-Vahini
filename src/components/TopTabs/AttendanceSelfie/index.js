...
const AttendanceSelfie = () => {
  ...
  const postData = async (obj) => {
    try {
      ...
      const response = await fetch(`https://js-member-backend.vercel.app/addattendanceselfiedata`, options);
      const data = await response.json();
      console.log(data);
    } catch (err) {
      console.log(`Error Occurred: ${err}`);
  ...
  const onDeleteSelfie = async (value) => {
    try{
      ...
      const response = await fetch(`https://js-member-backend.vercel.app/deleteattendanceselfie`,options);
      const data = await response.json();
      console.log(data)
  }
  catch(Err){
                                          ...
                                          <div style={{ backgroundColor: 'white', height: '300px', overflowY: 'auto' }} className="content rcyt-popup-cont">
                                            ...
                                            <table className="userTable">
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                    <td className='parameter'>Period</td>
                                                    <td className='value'>{image.period}</td>
                                                </tr>
                                                <tr>
...
export default AttendanceSelfie;
